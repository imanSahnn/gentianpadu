...
<body>
    <section class="bg-blue-100 dark:bg-gray-900 min-h-screen flex items-center justify-center">
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-lg xl:p-0 dark:bg-gray-800 dark:border-gray-700 mx-4 md:mx-auto">
                ...
                <form action="{{ route('sregister.save') }}" method="POST" enctype="multipart/form-data" class="space-y-4 md:space-y-6">
                    ...
                    <div class="flex items-start mt-4">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-light text-gray-500 dark:text-gray-300">I accept the <a @click.prevent="open = true" class="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">Terms and Conditions</a></label>
                        </div>
                    </div>
